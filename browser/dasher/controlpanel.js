...
class Control {
  ...
  get panelListener() {
    return this._panelListener;
  }
  set panelListener(panelListener) {
...
export default class ControlPanel {
  ...
  get_values() {
    return this.descend((structure, path, values) => {
      if (path.length === 0) {
  ...
  set_values(rootSettings) {
    this.descend((structure, path, settings) => {
      if (path.length === 0) {
