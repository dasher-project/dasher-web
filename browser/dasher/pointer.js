...
export default class Pointer {
  ...
  get multiplierLeftRight() {
    return this._multiplierLeftRight;
  }
  ...
  get x() {
    return this._rawX * this.multiplierLeftRight;
  }
  get y() {
    return this._rawY * this.multiplierUpDown;
  }
  get going() {
  ...
  get svgBoundingBox() {
    return this._svgBoundingBox;
  }
  set svgBoundingBox(svgBoundingBox) {
    this._svgBoundingBox = svgBoundingBox;
  }
